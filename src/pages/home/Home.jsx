                            ...
                            <div className="container-fluid">
                                <div className="row">
                                    ...
                                    <div className="col-lg-3 col-md-6  p-0">
                                        <div className="hero__inside__item hero__inside__item--small set-bg" data-setbg="img/hero/hero-2.jpg">
                                            <div className="hero__inside__item__text">
                                                <div className="hero__inside__item--meta">
                                                    <span>08</span>
                                                    <p>Aug</p>
                                        ...
                                        <div className="hero__inside__item hero__inside__item--small set-bg" data-setbg="img/hero/hero-3.jpg">
                                            <div className="hero__inside__item__text">
                                                <div className="hero__inside__item--meta">
                                                    <span>08</span>
                                                    <p>Aug</p>
                                    ...
                                    <div className="col-lg-3 col-md-6  p-0">
                                        <div className="hero__inside__item set-bg" data-setbg="img/hero/hero-4.jpg">
                                            <div className="hero__inside__item__text">
                                                <div className="hero__inside__item--meta">
                                                    <span>08</span>
                                                    <p>Aug</p>
                            ...
                            <div className="row">
                                <div className="col-lg-8 col-md-8">
                                    <div className="categories__post__item categories__post__item--large">
                                        <div className="categories__post__item__pic set-bg" data-setbg="img/categories/categories-post/cp-1.jpg">
                                        ...
                                        <div className="categories__post__item__text">
                                            ...
                                            <div className="post__social">
                                                <span>Share</span>
                                                <a href="#"><i className="fa fa-facebook" /> <span>82</span></a>
                                                <a href="#"><i className="fa fa-twitter" /> <span>24</span></a>
                                                <a href="#"><i className="fa fa-envelope-o" /> <span>08</span></a>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="row">
                                        <div className="col-lg-6 col-md-6 col-sm-6">
                                            <div className="categories__post__item">
                                                <div className="categories__post__item__pic small__item set-bg" data-setbg="img/categories/categories-post/cp-2.jpg">
                                                    <div className="post__meta">
                                                        <h4>08</h4>
                                                        <span>Aug</span>
                                                    </div>
                                            ...
                                            <div className="categories__post__item">
                                                <div className="categories__post__item__pic set-bg" data-setbg="img/categories/categories-post/cp-4.jpg">
                                                    <div className="post__meta">
                                                        <h4>08</h4>
                                                        <span>Aug</span>
                                                    </div>
                                            ...
                                            <div className="categories__post__item__plain set-bg" data-setbg="img/categories/categories-post/cp-6.jpg">
                                                <div className="categories__post__item__text">
                                                    <div className="post__meta">
                                                        <h4>08</h4>
                                                        <span>Aug</span>
                                            ...
                                            <div className="categories__post__item">
                                                <div className="categories__post__item__pic smaller__large set-bg" data-setbg="img/categories/categories-post/cp-8.jpg">
                                                    <div className="post__meta">
                                                        <h4>08</h4>
                                                        <span>Aug</span>
                                                    </div>
                                        ...
                                        <div className="col-lg-6 col-md-6 col-sm-6">
                                            <div className="categories__post__item">
                                                <div className="categories__post__item__pic smaller__large set-bg" data-setbg="img/categories/categories-post/cp-3.jpg">
                                                    <div className="post__meta">
                                                        <h4>08</h4>
                                                        <span>Aug</span>
                                                    </div>
                                            ...
                                            <div className="categories__post__item">
                                                <div className="categories__post__item__pic smaller__large set-bg" data-setbg="img/categories/categories-post/cp-5.jpg">
                                                    <div className="post__meta">
                                                        <h4>08</h4>
                                                        <span>Aug</span>
                                                    </div>
                                            ...
                                            <div className="categories__post__item">
                                                <div className="categories__post__item__pic set-bg" data-setbg="img/categories/categories-post/cp-7.jpg">
                                                    <div className="post__meta">
                                                        <h4>08</h4>
                                                        <span>Aug</span>
                                                    </div>
                                ...
                                <div className="col-lg-4 col-md-4">
                                    <div className="sidebar__item">
                                        ...
                                        <div className="sidebar__feature__item">
                                            ...
                                            <div className="sidebar__feature__item__large set-bg" data-setbg="img/sidebar/feature-post.jpg">
